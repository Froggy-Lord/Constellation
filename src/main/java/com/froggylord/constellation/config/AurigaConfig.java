...
public class AurigaConfig extends BaseConfigGroup {
    ...
    public boolean hoppityEggWaypointsHighlightCollected = false;
    public boolean hoppityEggWaypointsOnlyNearest = false;
    public boolean hoppityEggWaypointsBox = true;
    public boolean hoppityEggWaypointsBeam = true;
    public boolean hoppityEggWaypointsLabel = true;
    public boolean hoppityEggWaypointsInternalNames = false;
    public boolean hoppityEggWaypointsDistance = true;
    public boolean hoppityEggWaypointsLine = true;
    public boolean hoppityEggWaypointsThroughWalls = true;
    ...
    public int hoppityEggWaypointCollectedColor = 0xA0FF5555;
