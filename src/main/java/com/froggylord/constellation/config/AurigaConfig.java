...
public class AurigaConfig extends BaseConfigGroup {
    ...
    public boolean chocolateFactoryMilestoneWarning = true;
    public boolean chocolateFactoryTowerStateHighlight = true;
    public boolean chocolateFactoryExtraTooltipStats = true;
    public boolean chocolateFactoryPrestigeTooltip = true;
    public boolean chocolateFactoryTimeTowerTooltip = true;
    public int chocolateFactoryBarnThreshold = 1;
    public int chocolateFactoryBarnFullColor = 0xA0FF5555;
    public int chocolateFactoryMilestoneColor = 0xA0FF5555;
    public int chocolateFactoryTowerActiveColor = 0xA0FF55FF;
    public int chocolateFactoryTowerFullColor = 0xA0FF5555;
    public int chocolateFactoryLevelColor = 0xFFFFAA00;
    public boolean hoppityCollectionStats = true;
    public boolean hoppityCollectionHud = true;
    public boolean hoppityCollectionShowRarities = true;
    public boolean hoppityCollectionShowDuplicates = true;
    public boolean hoppityCollectionShowTotal = true;
    public boolean hoppityCollectionShowPages = true;
    public boolean hoppityCollectionShowProgress = true;
    public boolean hoppityCollectionTooltip = true;
    public boolean hoppityCollectionHighlightMissing = true;
    public boolean hoppityCollectionHighlightFound = false;
    public boolean hoppityCollectionRarityMissingHighlight = true;
    public boolean hoppityCollectionHighlightFactory = true;
    public boolean hoppityCollectionHighlightShop = true;
    public boolean hoppityCollectionHighlightRequirements = true;
    public boolean hoppityCollectionHighlightStrays = true;
    public boolean hoppityCollectionPersistProfiles = true;
    public int hoppityCollectionMissingColor = 0xA0FF5555;
    public int hoppityCollectionFoundColor = 0x8055FF55;
    public int hoppityCollectionFactoryColor = 0xA0FFFF55;
    public int hoppityCollectionShopColor = 0xA0FFAA00;
    public int hoppityCollectionRequirementColor = 0xA055FF55;
    public int hoppityCollectionStrayColor = 0xA055FFFF;
    public java.util.Map<String, Integer> hoppityRabbitCounts = new java.util.LinkedHashMap<>();
    public java.util.Map<String, String> hoppityRabbitRarities = new java.util.LinkedHashMap<>();
    public java.util.Map<String, Integer> hoppityCollectionProgress = new java.util.LinkedHashMap<>();
    public java.util.Map<String, String> hoppityCollectionPages = new java.util.LinkedHashMap<>();
