...
public class AquilaConfig extends BaseConfigGroup {
    ...
    public boolean crystalWaypointsSuite = true;
    public boolean crystalWaypointsHud = true;
    public boolean crystalWaypointsFindInChat = true;
    public boolean crystalWaypointsFindFromArea = true;
    public boolean crystalWaypointsCompassSolver = true;
    public boolean crystalWaypointsCompassGuard = true;
    public boolean crystalWaypointsCompassChat = true;
    public boolean crystalWaypointsCompassTitle = false;
    public boolean crystalWaypointsCompassSound = true;
    public boolean crystalWaypointsShowBox = true;
    public boolean crystalWaypointsShowBeam = true;
    public boolean crystalWaypointsShowLine = false;
    public boolean crystalWaypointsShowLabel = true;
    public boolean crystalWaypointsShowDistance = true;
    public boolean crystalWaypointsThroughWalls = true;
    public boolean crystalWaypointsOnlyNearest = false;
    public boolean crystalWaypointsAutoRemoveReached = false;
    public boolean crystalWaypointsPartyShare = true;
    public boolean crystalWaypointsShareFairyGrotto = false;
    public boolean crystalWaypointsHudShowSolver = true;
    public boolean crystalWaypointsHudShowCount = true;
    public boolean crystalWaypointsHudShowNearest = true;
    public int crystalWaypointsParticlesPerLine = 25;
    public int crystalWaypointsParticleDelayMillis = 500;
    public int crystalWaypointsParticleGapTenths = 9;
    public int crystalWaypointsUseDistance = 8;
    public int crystalWaypointsIntersectionToleranceTenths = 50;
    public int crystalWaypointsRenderRange = 1000;
    public int crystalWaypointsReachDistance = 5;
    public int crystalWaypointsBeamHeight = 15;
    public int crystalWaypointUnknownColor = 0xFFFFFFFF;
    public int crystalWaypointJungleColor = 0xFFAA00AA;
    public int crystalWaypointDivanColor = 0xFF55FF55;
    public int crystalWaypointGoblinColor = 0xFFFFAA00;
    public int crystalWaypointCityColor = 0xFF55FFFF;
    public int crystalWaypointKhazadColor = 0xFFFFFF55;
    public int crystalWaypointGrottoColor = 0xFFFF55FF;
    public int crystalWaypointDragonColor = 0xFFFFAA00;
    public int crystalWaypointCorleoneColor = 0xFFFFFFFF;
    public int crystalWaypointYolkarColor = 0xFFFF5555;
    public int crystalWaypointOdawaColor = 0xFFFF55FF;
    public int crystalWaypointKeyGuardianColor = 0xFFAAAAAA;
    public int crystalWaypointXalxColor = 0xFF55FF55;
