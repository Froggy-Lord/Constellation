...
public class HerculesConfig extends BaseConfigGroup {
    ...
    public boolean trevorSolver = true;
    public boolean trevorTalbotCircles = true;
    public boolean trevorTracker = true;
    public boolean trevorTrackerBetweenQuests = true;
    public boolean trevorTrackerPeltsPerHour = true;
    public boolean trevorTrackerRarities = true;
    public boolean trevorCooldownHud = true;
    public boolean trevorReadyAlert = true;
    public boolean trevorReadyTitle = true;
    public boolean trevorReadyChat = false;
    public boolean trevorReadySound = true;
    public boolean trevorMobDiedAlert = true;
    public boolean trevorMobDiedTitle = true;
    public boolean trevorMobDiedChat = false;
    public boolean trevorMobDiedSound = true;
    public boolean trevorAreaWaypoint = true;
    public boolean trevorTargetWaypoint = true;
    public boolean trevorWaypointBox = true;
    public boolean trevorWaypointBeam = true;
    public boolean trevorWaypointLine = false;
    public boolean trevorWaypointDistance = true;
    public boolean trevorThroughWalls = true;
    public boolean trevorWarpHotkey = false;
    public boolean trevorAcceptHotkey = false;
    public boolean trevorRequireFarmingIslands = true;
    public int trevorReadySeconds = 20;
    public int trevorWaypointRange = 512;
    public int trevorBeamHeight = 16;
    public int trevorAreaColor = 0xFFFFAA00;
    public int trevorTargetColor = 0xFF55FF55;
    public int trevorCircleColor = 0xFFFFAA00;
    public int trevorCircleSegments = 96;
    public int trevorTrackerIdleResetSeconds = 150;
    public String trevorTrackerOrder = "quests,pelts,rate,killed,self,trackable,untrackable,undetected,endangered,elusive";
