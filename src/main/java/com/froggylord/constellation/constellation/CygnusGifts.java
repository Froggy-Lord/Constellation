...
public final class CygnusGifts {
    ...
    public static boolean holdingGift(){Minecraft mc=Minecraft.getInstance();return mc.player!=null&&(GIFT_IDS.contains(LyraTooltips.marketId(mc.player.getMainHandItem()))||GIFT_IDS.contains(LyraTooltips.marketId(mc.player.getOffhandItem())));}
