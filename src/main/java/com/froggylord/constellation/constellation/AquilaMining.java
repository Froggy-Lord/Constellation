...
public class AquilaMining extends BaseConstellation {
    ...
    public void init(InitContext ctx) {
        ...
        registerRenderer(context -> { if (isEnabled() && cfg.enabled) { AquilaCorpseHelper.draw(context); AquilaMiningGuidance.draw(context); AquilaMiningAwareness.draw(context); AquilaMiningHighlights.draw(context); AquilaNucleusBarriers.draw(context); AquilaPickobulus.draw(context); AquilaMetalDetector.draw(context); } });
    }
    ...
    public void registerHud(HudManager hud) {
        ...
        hud.register(new com.froggylord.constellation.hud.MiningToolHudWidget(HudPosition.of(78, 124),
            () -> c.enabled && c.miningToolSuite && (c.drillFuelHud || c.pickonimbusHud)));
        hud.register(new com.froggylord.constellation.hud.FossilSolverHudWidget(HudPosition.of(78, 138),
