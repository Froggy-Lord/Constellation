...
public final class HerculesPests {
    ...
    private static Integer plotAt(double x,double z){int col=(int)Math.floor((x+240)/96),row=(int)Math.floor((z+240)/96);return row>=0&&row<5&&col>=0&&col<5?PLOT_IDS[row][col]:null;}
