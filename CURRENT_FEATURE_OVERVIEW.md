...
Container-attached decorative panels render below native items and tooltips while their Browse, value and shortcut click targets remain active.
...
- Open `Visuals` from the Hub to control title and ordinary out-of-game menu backdrops, buttons, sliders and reduced motion independently. Vanilla control behavior and navigation remain intact, while accessibility, language, warning, recovery, loading, account, Realms and third-party screens remain vanilla.
...
- Garden summary progression includes exact 15-level XP, visitor milestones, crop unlocks/Personal Bests, Jacob perk costs and Barn skins
