...
- **artemis** — hunting + foraging. exact caught, Lootshare and charm shard tracking; Bazaar value, profit per hour, profile/session history, high-value alerts and a movable hunting HUD; Galatea Hideonleaf, Invisibug, Birries, Shellwise and Coralot guidance; complete Lasso progress and REEL HUD; Fusion materials, value and result guidance
