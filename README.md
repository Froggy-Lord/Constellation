...
- **aquila** — mining. Powder/commission HUDs, persistent forge slots and reminders, commission destination guidance, live commission and crystal progress, exact Fetchur/Puzzler guidance, profile-safe mineshaft pity, cave-in/cold timing, Glacite corpse finder/key/profit tracking, own Golden/Diamond Goblin guidance, high-heat sound filtering, HOTM, fuel, Pickonimbus, Scatha, treasure/compass/nucleus and mining helpers
