...
- **andromeda** — the rift. live time/Motes/session HUD and low-time alerts; all 52 named, area-aware, profile-safe Enigma Souls with real Rift Guide synchronization and right-click menu routing; complete 2,201-node shortest-path navigation; Lava Path, Upside Down and Turbulator Mirrorverse guidance; scoreboard-driven compact/full Stillgore effigy waypoints; bounded boxes, beams, labels, lines, colors, ranges and manual correction controls
