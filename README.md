...
- **artemis** — hunting + foraging. exact caught, Lootshare and charm shard tracking; Bazaar value, profit per hour, profile/session history, high-value alerts and a movable hunting HUD; profile-safe Attribute Shard goals with SkyShards import, Hunting Box synchronization and completion alerts; Galatea Hideonleaf, Invisibug, Birries, Shellwise and Coralot guidance; complete Lasso progress and REEL HUD; Fusion materials, value and result guidance plus explicit repeat, confirm and cancel keybinds
