...
- **hercules** — farming. Garden visitor shopping, prices, sack availability, rewards and safeguards; advisory target speed/angles, yaw/pitch, crop rates and Jacob contest progress; Garden pest spawn alerts, finder borders, cooldown timer, kill/drop/profit statistics, custom plot-name learning, vacuum particle-path waypoints and persistent plot-spray expiry tracking
