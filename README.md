...
- **apollo** — hud. movable custom SkyBlock scoreboard with live server lines, cached stats, searchable ordering/visibility editor, filtering, styling and safe vanilla replacement; independently movable performance, location, movement, vitals and active-effects panels; rolling FPS/ping/TPS statistics, coordinates, clock, facing, yaw/pitch, dimension, actual/stat speed, parsed health/mana/defense/overflow/effective health and sorted potion timers
