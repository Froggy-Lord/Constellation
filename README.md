...
- **aquila** — mining. Powder/commission HUDs, completed-commission menu highlights and clickable calls, persistent forge slots and reminders, commission destination guidance, live commission and crystal progress, exact Fetchur/Puzzler guidance, profile-safe mineshaft pity, cave-in/cold timing, Glacite corpse finder/key/profit tracking, own Golden/Diamond Goblin guidance, Dwarven ore-carpet highlights, complete Crystal Hollows chest/lock guidance, exact Pickobulus block/drop preview and HUD, high-heat sound filtering, HOTM, fuel, Pickonimbus, Scatha, compass/nucleus and mining helpers
