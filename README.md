...
- **cygnus** — events + diana. authoritative mayor/minister/perk/election state, live/cache-backed event calendar, empirical burrows and Diana tracking, complete gift reward/value/profit statistics, Inquisitor alerts/sharing, seasonal helpers, and perk/coordinate-gated Carnival guidance
