...
- **auriga** — experiments + misc. complete advisory Chronomatron, Ultrasequencer and Superpairs state-machine solvers with click protection, memory, overlays and progress HUD; Chocolate Factory upgrade ranking, affordability/payback guidance, stray-rabbit alerts, prestige/Hitman status and profile-safe Time Tower reminders
