...
- **auriga** — experiments + misc. complete advisory Chronomatron, Ultrasequencer and Superpairs state-machine solvers with click protection, memory, overlays and progress HUD; remaining Auriga utility helpers are still being rebuilt
