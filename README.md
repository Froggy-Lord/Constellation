...
- **cygnus** — events + diana. live/cache-backed event calendar and reminders, deterministic SkyBlock date, empirical burrow waypoints, persistent mob/drop/coin tracking, Inquisitor alerts/coordinates/sharing, mayor info, jerry timer, spooky/winter/harvest helpers, and coordinate-gated Carnival guidance
