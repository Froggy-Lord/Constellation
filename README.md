...
- **artemis** — hunting + foraging. exact caught, Lootshare and charm shard tracking; Bazaar value, profit per hour, profile/session history, high-value alerts and a movable hunting HUD; profile-safe Attribute Shard goals, tier-to-max ranking, Hunting Box synchronization, completion alerts and complete box valuation; Heart of the Forest perk/currency guidance, Galatea Tree Progress, Moonglade Beacon tuning, Hideonleaf, Invisibug, Birries, Shellwise and Coralot guidance plus phantom/Fusion-machine sound controls; Huntaxe Absorptio confirmation lock; complete Lasso progress and REEL HUD; Fusion materials, value and result guidance plus explicit repeat, confirm and cancel keybinds
