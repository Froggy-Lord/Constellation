...
- **aquila** — mining. Powder/commission HUDs, completed-commission menu highlights and clickable calls, persistent forge slots and reminders, commission destination guidance, live commission and crystal progress, exact Fetchur/Puzzler guidance, profile-safe mineshaft pity, cave-in/cold timing, Glacite corpse finder/key/profit tracking, own Golden/Diamond Goblin guidance, Dwarven ore-carpet highlights, complete Crystal Hollows chest/lock and Metal Detector solving, exact Pickobulus block/drop preview, drill-fuel and Pickonimbus tool state, complete Fossil Excavator solving plus session/profile loot, Scrap, Dust, Powder and profit tracking, Fossil Muncher answers, high-heat sound filtering, HOTM, Scatha, compass/nucleus and mining helpers
