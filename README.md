...
- **cygnus** — events + diana. empirical burrow waypoints, persistent mob/drop/coin tracking, Inquisitor alerts/coordinates/sharing, calendar, mayor info, event pings, jerry timer, spooky/winter/harvest helpers, and coordinate-gated Carnival guidance
