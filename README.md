...
- **auriga** — experiments + misc. complete advisory Experimentation Table solvers; Chocolate Factory ranking and reminders; Anvil matching/protection; profile-safe God Potion, Cookie Buff and active-effect status with configurable alerts and HUDs
