...
- **cygnus** — events + diana. authoritative mayor/minister/perk/election state, live/cache-backed event calendar and reminders, deterministic SkyBlock date, empirical burrow waypoints, persistent mob/drop/coin tracking, Inquisitor alerts/coordinates/sharing, jerry timer, seasonal helpers, and perk/coordinate-gated Carnival guidance
