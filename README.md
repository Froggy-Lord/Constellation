...
- **hercules** — farming. Garden visitor shopping, prices, sack availability, rewards and safeguards; advisory target speed/angles, yaw/pitch, crop rates, true Farming Fortune and Jacob contest progress; Garden pest spawn alerts, finder borders, cooldown timer, kill/drop/profit statistics, custom plot-name learning, vacuum particle-path waypoints, persistent plot-spray expiry tracking, Configure Plots status highlighting, Stereo Harmony vinyl/crop guidance and Greenhouse growth diagnostics
