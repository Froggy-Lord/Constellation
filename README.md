...
- **auriga** — experiments + misc. complete advisory Chronomatron, Ultrasequencer and Superpairs state-machine solvers; Chocolate Factory ranking, timers and alerts; exact Anvil book matching, mismatch protection, matching-book discovery and status HUD
