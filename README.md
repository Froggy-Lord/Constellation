...
- **cygnus** — events + diana. calendar, mayor info, inquisitor waypoints, burrow chain, event pings, jerry timer, spooky/winter/harvest helpers, and coordinate-gated Catch a Fish and Zombie Shootout Carnival guidance
